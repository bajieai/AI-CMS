...
return [
    ...
    'image' => [
        ...
        // V2.9.31 AI3-2 Q4: 配图质量评分默认关闭，配置项控制
        'quality_score_enabled'  => (bool) env('ai.image.quality_score_enabled', false),
        'quality_score_threshold' => (int) env('ai.image.quality_score_threshold', 60),
        'providers'        => [
            'tongyi_wanxiang' => [
