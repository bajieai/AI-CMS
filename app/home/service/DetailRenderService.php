...
class DetailRenderService
{
     ...
     */
    public static function resolveTemplate(string $defaultTemplate, ?Cate $cate, ?Content $content = null): string
    {
    ...
    public static function render(
        ...
        return self::resolveTemplate($defaultTemplate, $cate, $content);
    }
