...
abstract class FrontBaseController extends \think\BaseController
{
    ...
    protected function initialize(): void
    {
        ...
        try {
            $configs = Cache::remember('site_configs', function () {
        ...
        try {
            $customVars = Cache::remember('custom_vars', function () {
        ...
        try {
            $enabledModules = Cache::remember('enabled_modules', function () {
        ...
        $this->app->view->assign([
            ...
            'member_unread_count' => ($this->isMemberLogin && $this->memberInfo) ? (function() {
                ...
                return Cache::remember($cacheKey, function() use ($mid) {
    ...
    protected function resolveMember(): void
    {
        ...
        if ($member && $member['status'] == 1) {
            ...
            $this->isMemberLogin = true;
            Cache::set($cacheKey, $this->memberInfo, 7200);
        }
    }
