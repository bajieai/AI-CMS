...
class TranslateLanguageController extends AdminBaseController
{
    ...
    public function toggle()
    {
        ...
        Setting::put('translate.enabled_languages', json_encode($enabledLanguages));
    ...
    public function sort()
    {
        ...
        Setting::put('translate.language_order', json_encode($order));
    ...
    public function custom()
    {
        ...
        Setting::put('translate.custom_languages', json_encode($customLanguages));
