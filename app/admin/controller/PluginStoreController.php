...
/**
 * 插件商店在线安装控制器 — V2.9.28 P-1（遗留兼容层）
 *
 * 注意：V2.9.35 新增 PluginStoreV2Controller 作为插件商店的主控制器。
 * 本 Controller 保留用于 V2.9.28 在线安装SSE流程和向后兼容。
 * 新功能开发请使用 PluginStoreV2Controller。
 *
 * 职责划分：
 * - PluginStoreController（本类）: V2.9.28 SSE在线安装流程（旧版）
 * - PluginStoreV2Controller: V2.9.35 商店浏览/详情/一键安装（新版）
 */
