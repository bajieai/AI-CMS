...
INSERT INTO `{prefix}content_ext` VALUES (1,1,1,'{\"product_price\": \"\", \"product_specs\": \"\", \"product_params\": \"\"}'),(2,1,3,'{\"info_author\": \"\", \"info_source\": \"\"}');
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='内容模型扩展字段';

INSERT INTO `{prefix}content_model_field` VALUES (1,3,'price','价格','number',NULL,'0','请输入产品价格','',0,0,1,10,1,1780903524,1780903524),(2,3,'stock','库存数量','number',NULL,'0','请输入库存数量','',0,0,1,20,1,1780903524,1780903524),(3,3,'spec','产品规格','textarea',NULL,'','请输入产品规格参数','',0,0,0,30,1,1780903524,1780903524),(4,3,'brand','品牌','text',NULL,'','请输入品牌名称','',0,0,0,40,1,1780903524,1780903524),(5,4,'client_name','客户名称','text',NULL,'','请输入客户/公司名称','',0,0,1,10,1,1780903524,1780903524),(6,4,'project_period','项目周期','text',NULL,'','如：2024.01-2024.06','',0,0,0,20,1,1780903524,1780903524),(7,4,'industry','所属行业','select','[\"互联网\",\"金融\",\"教育\",\"医疗\",\"制造\",\"其他\"]','互联网','请选择所属行业','',0,0,0,30,1,1780903524,1780903524),(8,1,'source','文章来源','text',NULL,'','请输入文章来源','',0,0,0,10,1,1780903524,1780903524),(9,1,'author','作者','text',NULL,'','请输入作者姓名','',0,0,0,20,1,1780903524,1780903524),(10,1,'is_top','是否置顶','radio','[\"否\",\"是\"]','0','','',0,0,0,30,1,1780903524,1780903524),(11,5,'version','版本号','text',NULL,'1.0.0','如：1.0.0','',0,0,1,10,1,1780903524,1780903524),(12,5,'file_size','文件大小','text',NULL,'','如：15.6 MB','',0,0,0,20,1,1780903524,1780903524),(13,5,'download_url','下载链接','text',NULL,'','请输入下载链接','',0,0,1,30,1,1780903524,1780903524),(14,6,'salary_range','薪资范围','text',NULL,'','如：15K-25K','',0,0,1,10,1,1780903524,1780903524),(15,6,'location','工作地点','text',NULL,'','如：北京市海淀区','',0,0,1,20,1,1780903524,1780903524),(16,6,'education','学历要求','select','[\"不限\",\"大专\",\"本科\",\"硕士\",\"博士\"]','本科','请选择学历要求','',0,0,1,30,1,1780903524,1780903524),(17,2,'subtitle','副标题','text',NULL,'','请输入副标题','',0,0,0,10,1,1780903524,1780903524),(18,2,'cover_image','封面图','image',NULL,'','请上传封面图片','',0,0,0,20,1,1780903524,1780903524),(19,7,'gallery','图集','image',NULL,'','请上传图片，可多选','',0,0,0,20,1,1782034032,1782034032),(20,7,'image_description','图片说明','textarea',NULL,'','请输入图片描述','',0,0,0,20,1,1782034032,1782034032),(21,7,'photographer','摄影师','text',NULL,'','请输入摄影师姓名','',0,0,0,30,1,1782034032,1782034032),(22,8,'video_url','视频链接','text',NULL,'','请输入视频播放链接','',0,0,1,10,1,1782034032,1782034032),(23,8,'video_cover','视频封面','image',NULL,'','请上传视频封面图','',0,0,0,20,1,1782034032,1782034032),(24,8,'duration','视频时长','text',NULL,'','如：12:30','',0,0,0,30,1,1782034032,1782034032),(25,7,'shoot_date','拍摄日期','date',NULL,'','请选择拍摄日期','',0,1,0,40,1,1782034032,1782034032),(26,7,'shoot_location','拍摄地点','text',NULL,'','请输入拍摄地点','',0,0,0,50,1,1782034032,1782034032),(27,8,'video_summary','视频简介','textarea',NULL,'','请输入视频简介','',0,1,0,40,1,1782034032,1782034032),(28,8,'video_platform','播放平台','select','[\"本地\",\"B站\",\"优酷\",\"腾讯视频\",\"YouTube\",\"其他\"]','本地','请选择播放平台','',0,0,0,50,1,1782034032,1782034032),(29,2,'page_template','页面模板','select','[\"默认\",\"全宽\",\"左侧栏\",\"右侧栏\"]','默认','请选择页面布局模板','',0,0,0,30,1,1782034032,1782034032),(30,2,'redirect_url','跳转链接','text',NULL,'','如需跳转到其他页面请填写URL','',0,0,0,40,1,1782034032,1782034032);
...
INSERT INTO `{prefix}content_version` VALUES (1,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"product_price\":\"\",\"product_specs\":\"\",\"product_params\":\"\"}','',1,1779207823),(2,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"product_price\":\"\",\"product_specs\":\"\",\"product_params\":\"\"}','',1,1779208000),(3,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"product_price\":\"\",\"product_specs\":\"\",\"product_params\":\"\"}','',1,1779208051),(4,1,'11112234','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779211643),(5,1,'11112234','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779211646),(6,1,'11112234','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779211651),(7,1,'11112234','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779211662),(8,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779211797),(9,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779211817),(10,1,'11112235','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779211879),(11,1,'11112235','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779211907),(12,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779212211),(13,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779212370),(14,1,'11112239','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779212510),(15,1,'11112233','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779214652),(16,1,'1111269','<p>test测试</p>\n<p>test测试</p>\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779214697),(17,1,'1111261','<p>test测试</p>\n<p>test测试</p>\n<p>test测试</p>','','',0,0,'{\"info_author\":\"\",\"info_source\":\"\"}','',1,1779246054);
