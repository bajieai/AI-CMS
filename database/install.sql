...
VALUES
(1, '八界AI-CMS 智能内容管理系统', '/assets/images/banner1.jpg', '', '_self', 1, 1, 0, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
(2, 'AI驱动的内容创作与管理', '/assets/images/banner2.jpg', '', '_self', 2, 1, 0, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
...
CREATE TABLE `{prefix}cate` (
  ...
  `type` tinyint(4) NOT NULL DEFAULT '1' COMMENT '分类类型(动态读取content_model表,预设1-8,新建≥9)',
...
INSERT INTO `{prefix}cate` VALUES (1,'新闻动态',1,1,'','','',0,1,1,1776933035,1776933035,'formal',0,'info'),(2,'产品中心',3,3,'','','',0,2,1,1776933035,1776933035,'formal',0,'products'),(3,'成功案例',4,4,'','','',0,3,1,1776933035,1776933035,'formal',0,'cases'),(4,'资料下载',5,5,'','','',0,4,1,1776933035,1776933035,'formal',0,'downloads'),(5,'人才招聘',6,6,'','','',0,5,1,1776933035,1776933035,'formal',0,'jobs'),(6,'关于我们',2,2,'','','',0,6,1,1776933035,1776933035,'formal',2,'about'),(7,'联系方式',2,2,'','','',0,7,1,1776933035,1776933035,'formal',3,'contact'),(8,'公司简介',2,2,'','','',0,8,1,1776933035,1776933035,'formal',4,'company');
...
CREATE TABLE `{prefix}content` (
  ...
  `type` tinyint(4) NOT NULL DEFAULT '1' COMMENT '内容类型(预置1-8，和内容模型ID保持一致)',
...
INSERT INTO `{prefix}content` (`id`,`title`,`content`,`excerpt`,`type`,`status`,`cate_id`,`model_id`,`model_identifier`,`create_time`,`update_time`,`seo_title`,`seo_keywords`,`seo_description`) VALUES
(2,'关于我们','<p>八界AI-CMS是一款由AI驱动的内容管理系统...</p>','',2,2,6,2,'model_page',1776933035,1776933035,'关于我们 - 八界AI-CMS','关于我们,公司介绍','八界AI-CMS是一款由AI驱动的内容管理系统'),
(3,'联系方式','<p>电话：xxx-xxxx-xxxx<br>邮箱：contact@example.com<br>地址：xx省xx市xx区xx路xx号</p>','',2,2,7,2,'model_page',1776933035,1776933035,'联系方式 - 八界AI-CMS','联系方式,电话,邮箱','联系我们'),
(4,'公司简介','<p>湖北八界智能技术有限公司成立于xxxx年...</p>','',2,2,8,2,'model_page',1776933035,1776933035,'公司简介 - 八界AI-CMS','公司简介,企业介绍','湖北八界智能技术有限公司简介');
...
INSERT INTO `{prefix}content_ext` VALUES (1,1,1,'{\"source\": \"\", \"author\": \"\", \"is_top\": \"0\"}'),(2,1,3,'{\"price\": \"\", \"stock\": \"\", \"spec\": \"\", \"brand\": \"\"}');
...
CREATE TABLE `{prefix}content_model` (
  ...
  `type` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '关联内容类型(预设1-8,新建模型自动分配≥9,与cate.type联动)',
  ...
  KEY `idx_type` (`type`),
  KEY `idx_status_sort` (`status`,`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='内容模型定义';

INSERT INTO `{prefix}content_model` VALUES (1,'信息资讯','信息资讯','model_info','model_info','','用于发布信息文章，支持来源、作者等字段','用于发布信息文章，支持来源、作者等字段','','','','','','','bi bi-newspaper','bi bi-newspaper',NULL,NULL,'',0,1,1,10,0,1,NULL,1780903524,1780903524,0,0),(2,'单页介绍','单页介绍','model_page','model_page','','用于单页内容展示，支持副标题、封面图等字段','用于单页内容展示，支持副标题、封面图等字段','','','','','','','bi bi-file-earmark-text','bi bi-file-earmark-text',NULL,NULL,'',0,2,1,20,0,1,NULL,1780903524,1780903524,0,0),(3,'产品信息','产品信息','model_product','model_product','','用于展示产品详情，支持价格、库存、规格等字段','用于展示产品详情，支持价格、库存、规格等字段','','','','','','','bi bi-box-seam','bi bi-box-seam',NULL,NULL,'',0,3,1,30,0,1,NULL,1780903524,1780903524,0,0),(4,'企业案例','企业案例','model_case','model_case','','用于展示企业案例/项目，支持客户名称、项目周期等字段','用于展示企业案例/项目，支持客户名称、项目周期等字段','','','','','','','bi bi-briefcase','bi bi-briefcase',NULL,NULL,'',0,4,1,40,0,1,NULL,1780903524,1780903524,0,0),(5,'软件下载','软件下载','model_download','model_download','','用于软件/资源下载，支持版本号、文件大小、下载次数等字段','用于软件/资源下载，支持版本号、文件大小、下载次数等字段','','','','','','','bi bi-download','bi bi-download',NULL,NULL,'',0,5,1,50,0,1,NULL,1780903524,1780903524,0,0),(6,'人才招聘','人才招聘','model_job','model_job','','用于发布招聘信息，支持薪资范围、工作地点、学历要求等字段','用于发布招聘信息，支持薪资范围、工作地点、学历要求等字段','','','','','','','bi bi-people','bi bi-people',NULL,NULL,'',0,6,1,60,0,1,NULL,1780903524,1780903524,0,0),(7,'图片图集','图片图集','model_image','model_image','','用于图片画廊、作品集展示，支持多图轮播、图片说明等字段','用于图片画廊、作品集展示，支持多图轮播、图片说明等字段','{$title} - 图集 - {$site_name}','{$title},图片,图集,作品集','{$title}图片图集展示页面','content/image_show','list_image','detail_image','bi bi-images','bi bi-images',NULL,NULL,'',0,7,1,70,0,1,NULL,1782034032,1782034032,0,0),(8,'视频内容','视频内容','model_video','model_video','','用于视频内容展示与播放，支持视频链接、时长、封面等字段','用于视频内容展示与播放，支持视频链接、时长、封面等字段','{$title} - 视频 - {$site_name}','{$title},视频,播放','{$title}视频播放页面','content/video_show','list_video','detail_video','bi bi-play-btn','bi bi-play-btn',NULL,NULL,'',0,8,1,80,0,1,NULL,1782034032,1782034032,0,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='内容模型扩展字段';

INSERT INTO `{prefix}content_model_field` VALUES (1,3,'price','价格','number',NULL,'0','请输入产品价格','',0,0,1,10,1,1780903524,1780903524),(2,3,'stock','库存数量','number',NULL,'0','请输入库存数量','',0,0,1,20,1,1780903524,1780903524),(3,3,'spec','产品规格','textarea',NULL,'','请输入产品规格参数','',0,0,0,30,1,1780903524,1780903524),(4,3,'brand','品牌','text',NULL,'','请输入品牌名称','',0,0,0,40,1,1780903524,1780903524),(5,4,'client_name','客户名称','text',NULL,'','请输入客户/公司名称','',0,0,1,10,1,1780903524,1780903524),(6,4,'project_period','项目周期','text',NULL,'','如：2024.01-2024.06','',0,0,0,20,1,1780903524,1780903524),(7,4,'industry','所属行业','select','[\"互联网\",\"金融\",\"教育\",\"医疗\",\"制造\",\"其他\"]','互联网','请选择所属行业','',0,0,0,30,1,1780903524,1780903524),(8,1,'source','文章来源','text',NULL,'','请输入文章来源','',0,0,0,10,1,1780903524,1780903524),(9,1,'author','发布者','text',NULL,'','请输入发布者','',0,0,0,20,1,1780903524,1780903524),(10,1,'is_top','是否置顶','radio','[\"否\",\"是\"]','0','','',0,0,0,30,1,1780903524,1780903524),(11,5,'version','版本号','text',NULL,'1.0.0','如：1.0.0','',0,0,1,10,1,1780903524,1780903524),(12,5,'file_size','文件大小','text',NULL,'','如：15.6 MB','',0,0,0,20,1,1780903524,1780903524),(13,5,'download_url','下载链接','text',NULL,'','请输入下载链接','',0,0,1,30,1,1780903524,1780903524),(14,6,'salary_range','薪资范围','text',NULL,'','如：15K-25K','',0,0,1,10,1,1780903524,1780903524),(15,6,'location','工作地点','text',NULL,'','如：北京市海淀区','',0,0,1,20,1,1780903524,1780903524),(16,6,'education','学历要求','select','[\"不限\",\"大专\",\"本科\",\"硕士\",\"博士\"]','本科','请选择学历要求','',0,0,1,30,1,1780903524,1780903524),(17,2,'subtitle','副标题','text',NULL,'','请输入副标题','',0,0,0,10,1,1780903524,1780903524),(18,2,'cover_image','封面图','image',NULL,'','请上传封面图片','',0,0,0,20,1,1780903524,1780903524),(19,7,'gallery','图集','image',NULL,'','请上传图片，可多选','',0,0,0,20,1,1782034032,1782034032),(20,7,'image_description','图片说明','textarea',NULL,'','请输入图片描述','',0,0,0,20,1,1782034032,1782034032),(21,7,'photographer','摄影师','text',NULL,'','请输入摄影师姓名','',0,0,0,30,1,1782034032,1782034032),(22,8,'video_url','视频链接','text',NULL,'','请输入视频播放链接','',0,0,1,10,1,1782034032,1782034032),(23,8,'video_cover','视频封面','image',NULL,'','请上传视频封面图','',0,0,0,20,1,1782034032,1782034032),(24,8,'duration','视频时长','text',NULL,'','如：12:30','',0,0,0,30,1,1782034032,1782034032),(25,7,'shoot_date','拍摄日期','date',NULL,'','请选择拍摄日期','',0,1,0,40,1,1782034032,1782034032),(26,7,'shoot_location','拍摄地点','text',NULL,'','请输入拍摄地点','',0,0,0,50,1,1782034032,1782034032),(27,8,'video_summary','视频简介','textarea',NULL,'','请输入视频简介','',0,1,0,40,1,1782034032,1782034032),(28,8,'video_platform','播放平台','select','[\"本地\",\"B站\",\"优酷\",\"腾讯视频\",\"YouTube\",\"其他\"]','本地','请选择播放平台','',0,0,0,50,1,1782034032,1782034032),(29,2,'page_template','页面模板','select','[\"默认\",\"全宽\",\"左侧栏\",\"右侧栏\"]','默认','请选择页面布局模板','',0,0,0,30,1,1782034032,1782034032),(30,2,'redirect_url','跳转链接','text',NULL,'','如需跳转到其他页面请填写URL','',0,0,0,40,1,1782034032,1782034032),(31,1,'contact','联系方式','text',NULL,'','请输入联系方式','',0,0,0,25,1,1782034032,1782034032);
...
INSERT INTO `{prefix}content_version` VALUES (1,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"price\":\"\",\"stock\":\"\",\"spec\":\"\",\"brand\":\"\"}','',1,1779207823),(2,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"price\":\"\",\"stock\":\"\",\"spec\":\"\",\"brand\":\"\"}','',1,1779208000),(3,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"price\":\"\",\"stock\":\"\",\"spec\":\"\",\"brand\":\"\"}','',1,1779208051),(4,1,'11112234','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779211643),(5,1,'11112234','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779211646),(6,1,'11112234','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779211651),(7,1,'11112234','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779211662),(8,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779211797),(9,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779211817),(10,1,'11112235','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779211879),(11,1,'11112235','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779211907),(12,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779212211),(13,1,'1111223','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779212370),(14,1,'11112239','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779212510),(15,1,'11112233','<p>test测试</p>\r\n<p>test测试</p>\r\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779214652),(16,1,'1111269','<p>test测试</p>\n<p>test测试</p>\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779214697),(17,1,'1111261','<p>test测试</p>\n<p>test测试</p>\n<p>test测试</p>','','',0,0,'{\"author\":\"\",\"source\":\"\",\"is_top\":\"0\"}','',1,1779246054);
