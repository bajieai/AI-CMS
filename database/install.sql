...
CREATE TABLE `{prefix}cate` (
  ...
  `type` tinyint(4) NOT NULL DEFAULT '1' COMMENT '分类类型:1产品/2案例/3信息/4下载/5招聘/6单页',
...
CREATE TABLE `{prefix}content_model` (
  ...
  `type` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '关联内容类型(1产品/2案例/3信息/4下载/5招聘/6单页)',
