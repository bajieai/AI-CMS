...
if (file_exists(__DIR__ . '/../install.lock')) {
    ...
    if (stripos($uri, '/install.php/index/step5') === false && stripos($uri, 'step5') === false) {
...
} elseif (!isset($_GET['s']) && !isset($_SERVER['PATH_INFO']) && strpos($uriPath, '/install/') === 0) {
    $pathInfo = substr($uriPath, strlen('/install'));
